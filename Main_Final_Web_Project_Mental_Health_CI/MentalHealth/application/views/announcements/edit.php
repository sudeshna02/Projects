          ...
          <div class="row mb-5">
            <div class="col">
              <h3>
                ...
                <span class="text-uppercase text-danger">/</span><span class="text-muted small"> Edit An Announcement</span>
              </h3>
            </div>
          </div>
          <!-- end of title row -->
...
<!--################## main content ################-->
                    ...
                    <form action="<?= base_url() ?>/admin/manage/announcement/edit/<?= $announcement['aid']?>" method="POST" enctype="multipart/form-data">
                    ...
                    <!-- Category Name -a- -->
                        ...
                        <div class="input-group col-lg-9 mb-4">
                            ...
                            <input id="name" type="text" name="anntitle" placeholder="<?= $announcement['atitle']?>" class="form-control bg-white border-left-0 border-md">
                        </div>
                        ...
                        <div class="input-group col-lg-9 mb-4">
                            ...
                            <input id="name" type="textarea" name="anncontent" placeholder="<?= $announcement['acontent']?>" class="form-control bg-white border-left-0 border-md">
                        </div>
