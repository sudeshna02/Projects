                        ...
                        <form action="<?= base_url() ?>sendRequest" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="row request-form">
                            ...
                            <div class="input-group col-lg-4 mb-4">
                                ...
                                <input id="lastName" type="text" name="middlename" placeholder="Middle Name" class="form-control bg-white border-left-0 border-md">
                            </div>
                            ...
                            <div class="input-group col-lg-12 mb-2">
                                ...
                                <input type="text" name="email" id="email" placeholder="Email Address" class="form-control bg-white border-left-0 border-md" required>

                            </div>

                            <span class="ml-4 mb-1" id="email_result"></span>
                      
                             <div class="col-lg-12 mt-3 mb-1">
                            <small class="text-muted">Kindly Enter A Valid Contact Number!</small>
                            </div>
                            <!-- Phone Number -->
