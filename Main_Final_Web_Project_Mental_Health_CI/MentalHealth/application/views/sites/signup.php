                ...
                <form action="<?= base_url() ?>user/register" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="input-group col-lg-12 mb-4">
                            ...
                            <select id="countryCode" name="country_code" style="max-width: 80px" class="custom-select form-control bg-white border-left-0 border-md h-100 font-weight-bold text-muted" value="<?= set_value('country_code')?>">
