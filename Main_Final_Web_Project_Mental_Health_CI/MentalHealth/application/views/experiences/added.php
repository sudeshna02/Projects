          ...
          <div class="row mb-5">
            <div class="col">
              <h3>
                ...
                ><span class="text-muted small"> Experiences</span><span class="text-uppercase text-danger"> /</span><span class="text-muted small"> View - All The Experiences Added By You  <i class="fa fa-comments mr-3 text-muted"></i></span>
              </h3>
            </div>
          </div>
          <!-- end of title row -->

              <?php if($success = $this->session->flashdata('experience_edit_successful')):?>
                    <div class="row mt-5">
                        <div class="col-lg-9">
                ...
                <?php endif;?>  
                          ...
                          <?php if($success = $this->session->flashdata('experience_successful')):?>
                    <div class="row mt-5">
                        <div class="col-lg-9">
                            <div class="alert alert-success">
                                <?= $success ?>
            ...
            <div class="col-md-12 main-datatable">
                <div class="card_body">
                    <div class="row d-flex">
                        ...
                        <button type="button" class="btn btn-info experienceModal" >
                            <i class="bi bi-plus-circle"></i>  Post New Experience
                        </button>
                            ...
                            <tbody>
                              <?php foreach ($experiences as $experience) { ?>
                                <tr>
                                    ...
                                    <td> 
                                        <button type="submit" class="btn btn-info editExperience" 

                                        exId="<?= $experience['eid'] ?>"
                                        title="<?= $experience['etitle'] ?>"
                                        desc="<?= $experience['edesc'] ?>"
                                        status="<?= $experience['estatus']?>">
