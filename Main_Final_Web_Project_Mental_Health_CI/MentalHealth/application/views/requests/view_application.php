          ...
          <div class="row mb-5">
            <div class="col">
              <h3>
                ...
                ><span class="text-muted small"> Requests</span><span class="text-uppercase text-danger"> /</span><span class="text-muted small"> View - Applications</span>
              </h3>
            </div>
          </div>
          <!-- end of title row -->
               ...
               <!--################## main content ################-->
                ...
                <div class="card_body">
                    <div class="row d-flex">
                        ...
                        <span class="d-inline-block" data-toggle="popover" data-content="You as an administrator cannot add a applications!">
                          <button class="btn btn-info" style="pointer-events: none;" type="button" disabled><i class="bi bi-plus-circle"></i> Add A New Application</button>
                        </span>
                            ...
                            <tbody>
                              <?php foreach ($requests as $diary) { ?>
                                <tr>
                                    ...
                                    <td><?= $diary['rdesc'] ?></td>
                                    <td><a href="<?= site_url() ?>assets/CVs/<?= $diary['rquali'] ?>" download="<?= $diary['rquali'] ?>"><?= $diary['rquali'] ?></td>
                                    <td><span class="mode mode_on">Active</span></td>
                                    <td>
                                        
                                      
                                         <button type="submit" class="btn btn-info approveApplication" 

                                         request-id="<?=$diary['rid']?>"
