          ...
          <div class="row mb-5">
            <div class="col">
              <h3>
                ...
                ><span class="text-muted small"> Requests</span><span class="text-uppercase text-danger"> /</span><span class="text-muted small"> View - Requests Sent By Patients</span>
              </h3>
            </div>
          </div>
          <!-- end of title row -->
                        ...
                        <table style="width:100%;" id="filtertable" class="table cust-datatable dataTable no-footer">
                            <thead>
                                <tr>
                                    ...
                                    <th style="min-width:10px;"> Message </th>
                            ...
                            <tbody>
                              <?php foreach ($requests as $diary) { ?>
                                <tr>
                                    ...
                                    <?php if($diary['approval'] == '1'){ ?>
                                        <button type="submit" class="btn btn-info approveRequestPatient" 
