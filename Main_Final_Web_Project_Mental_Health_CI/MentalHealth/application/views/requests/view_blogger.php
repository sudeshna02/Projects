          ...
          <div class="row mb-5">
            <div class="col">
              <h3>
                ...
                ><span class="text-muted small"> Requests</span><span class="text-uppercase text-danger"> /</span><span class="text-muted small"> View - Requests Sent By Bloggers</span>
              </h3>
            </div>
          </div>
          <!-- end of title row -->
                            ...
                            <tbody>
                              <?php foreach ($requests as $diary) { ?>
                                <tr>
                                    ...
                                    <td>
                                    <?php if($diary['approval'] == '1'){ ?>
                                         <button type="submit" class="btn btn-info approveRequestBlogger" 
