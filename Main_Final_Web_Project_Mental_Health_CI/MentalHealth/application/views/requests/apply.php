                        ...
                        <form action="<?= base_url() ?>sendApplication" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="row request-form">
                            ...
                            <div class="col-lg-12">
                              ...
                              <small class="mb-1 text-muted">If you have already applied please wait for the response! or Kindly Enter A Valid Email Address! </small>
                            </div>
                            ...
                            <div class="col-lg-12">
                              ...
                              <small class="mb-1 text-muted">If you have already applied please wait for the response! or Kindly Enter A Valid Contact Number!</small>
                            </div>
                            ...
                            <!-- CV -->
                            <div class="form-group col-lg-7 pl-4">

                                <label for="exampleFormControlFile1">Drop your CV here:</label> 
                                <small class="text-danger"><?php echo form_error('file','<p class="help-block">','</p>'); ?></small>
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" name="file" id="inputGroupFile02" value="<?= set_value('file')?>" required>
                                        <label class="custom-file-label" for="inputGroupFile02" aria-describedby="inputGroupFileAddon02">Choose file</label>
                                    </div>
                                      <small class="text-muted">Please use pdf formats only!</small>
                            </div>
