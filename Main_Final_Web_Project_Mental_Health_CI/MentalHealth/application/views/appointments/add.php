          ...
          <div class="row mb-5">
            <div class="col">
              <h3>
                ...
                <span class="text-uppercase text-danger">/</span><span class="text-muted small"> Add An Appointment <i class="bi bi-plus-circle text-danger"></i></span>
              </h3>
            </div>
          </div>
          <!-- end of title row -->
...
<!-- Registeration Form -->
          ...
          <!--################## main content ################-->
                    ...
                    <form action="<?= base_url() ?>appointment/add" method="POST" enctype="multipart/form-data">
                    ...
                    <!-- User category -->
                        ...
                        <div class="input-group col-lg-9 mb-4">
                            ...
                            <input id="name" type="text" name="apptitle" placeholder="Title" class="form-control bg-white border-left-0 border-md" required>
                        </div>
                        ...
                        <div class="input-group col-lg-9 mb-4">
                            ...
                            <textarea class="form-control bg-white border-left-0 border-md" placeholder="Description" id="exampleFormControlTextarea1" name="appdesc" rows="6" required></textarea>
                        </div>
                        ...
                        <div class="input-group col-lg-3 mt-4">
                              ...
                              <div class="input-group col-lg-9 mb-4">
                              <div class="col-12">
                                <input class="form-control bg-white border-md" type="date" name="appdate" id="example-date-input">
                              </div>
                        </div>
                        ...
                        <div class="input-group col-lg-3 mt-4">
                              ...
                              <div class="input-group col-lg-9 mb-4">
                              <div class="col-12">
                                <input class="form-control bg-white border-md" type="time" name="apptime" id="example-time-input">
                              </div>
                        </div>
