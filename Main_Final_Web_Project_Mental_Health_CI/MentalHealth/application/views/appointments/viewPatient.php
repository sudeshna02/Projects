          ...
          <div class="row mb-5">
            <div class="col">
              <h3>
                ...
                ><span class="text-muted small"> Appointments</span><span class="text-uppercase text-danger"> /</span><span class="text-muted small"> View - All The Appointments You Have To Attend <i class="fa fa-calendar-check mr-3 text-muted"></i></span>
              </h3>
            </div>
          </div>
          <!-- end of title row -->
