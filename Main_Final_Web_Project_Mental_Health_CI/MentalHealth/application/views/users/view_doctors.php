    ...
    <div class="row mb-5">
        <div class="col">
            <h3>
                ...
                ><span class="text-muted small"> Users</span><span class="text-uppercase text-danger"> /</span><span class="text-muted small"> View - Doctors <i class="fas fa-user-md mr-3 text-muted"></i></span>
            </h3>
        </div>
    </div>
    <!-- end of title row -->
            ...
            <div class="col-md-12 main-datatable">
                <div class="card_body">
                    <div class="row d-flex">
                        ...
                        <span class="d-inline-block" data-toggle="popover" data-content="View Application In Requests And Approve The Doctor To Register!">
                          <button class="btn btn-info" style="pointer-events: none;" type="button" disabled><i class="bi bi-person-plus"></i> Register</button>
                        </span>
                        ...
                        <table style="width:100%;" id="filtertable" class="table cust-datatable dataTable no-footer">
                            ...
                            <tbody>
                              <?php foreach ($requests as $diary) { ?>
                                <tr>
                                    <td><?= $diary['sfirstname'] . ' ' . $diary['smiddlename'] . ' ' . $diary['ssurname'] ?></td>
                                    ...
                                    <td>
                                        <button type="submit" class="btn btn-warning viewDetail" username-id="<?= $diary['susername'] ?>"  meet-id="<?= $diary['meet_link'] ?>">
                                    ...
                                    <td>                      
                                         <button type="submit" class="btn btn-info editDoctorUser"
