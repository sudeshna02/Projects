          ...
          <div class="row mb-5">
            <div class="col">
              <h3>
                ...
                <span class="text-uppercase text-danger">/</span><span class="text-muted small"> Add A Meeting <i class="bi bi-plus-circle"></i></span>
              </h3>
            </div>
          </div>
          <!-- end of title row -->

                    <form action="<?= base_url() ?>meeting/add" method="POST" enctype="multipart/form-data">
                    <div class="row w-80 m-2">
                        ...
                        <div class="input-group col-lg-9 mb-4">
                            ...
                            <input id="name" type="text" name="meetitle" placeholder="Title" class="form-control bg-white border-left-0 border-md" required>
                        </div>
                        ...
                        <div class="input-group col-lg-9 mb-4">
                            ...
                            <textarea class="form-control bg-white border-left-0 border-md" placeholder="Description" id="exampleFormControlTextarea1" name="meedesc" rows="6" required></textarea>
                        </div>
                     ...
                     <!-- User category -->
                        ...
                        <div class="input-group col-lg-9 mb-4">
                            ...
                            <select id="status" name="meestatus" class="form-control custom-select bg-white border-left-0 border-md" required>
